  ...
  settings: {
    ...
    sections: {
      ...
      provider: {
        ...
        modelHint: "Provider 切换只允许在同模型、同维度之间进行，例如 Ollama 1 的 bge-m3 / 1024 切换到 Ollama 2、硅基流动或 OpenRouter 的 bge-m3 / 1024；不同模型或维度会创建不兼容向量空间，系统会拒绝直接切换。",
  ...
  settings: {
    ...
    sections: {
      ...
      provider: {
        ...
        modelHint: "Provider switching is allowed only between the same model and dimension, such as Ollama 1 bge-m3 / 1024 to Ollama 2, SiliconFlow, or OpenRouter bge-m3 / 1024. Different models or dimensions create incompatible vector spaces and are rejected.",
