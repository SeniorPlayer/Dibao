...
当前状态：In Progress。单用户 auth、首次设置向导、feed 管理闭环、后台刷新、数据保留 foundation 和设置页已完成，Docker、E2E 和用户文档仍待完成。
...
1. `R-08 / R-09 / R-10 / M3-01 / M3-02 / M3-03 / M3-04`: Embedding provider, queue, and sqlite-vec production path。
2. `R-11 / R-12 / M3-05 / M3-06`: Profile Algorithm v0 and Ranking v1。
3. `R-14 / R-15 / M2-07 / M2-08 / M2-12`: Docker, MVP E2E smoke, and user docs。
