...
- 已完成基础工程、数据库、单用户 setup/auth/session、RSS 入库、OPML API、Web OPML UI、feed folder 展示筛选、文章列表分页、基础 Web 阅读器、文章动作、baseline ranking、推荐解释和 i18n foundation。
- 尚未完成让普通自托管用户可用的关键闭环：首次设置向导、feed 管理 UI、后台刷新、Docker 打包、设置页、embedding provider、embedding job pipeline、sqlite-vec 生产集成、Profile Algorithm v0、推荐排序 v1、E2E 测试。
