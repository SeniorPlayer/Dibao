...
- 当前系统已达到第一批自托管用户 MVP 发布标准；后续重点转向搜索、移动端打磨、PWA 和推荐解释/迁移增强。
...
1. `M1-12 / R-16`: Read progress capture and Search v0。
2. `M3-07 / M3-08 / M3-10`: Explanation v1, reindex/model migration, and diversity/duplicate penalties。
3. `R-17 / R-18`: Mobile browser polish and PWA foundation。
